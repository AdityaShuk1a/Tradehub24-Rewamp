...
const Footer = () => {
  return (
    <div className='h-[100vh] ' >
         <div className='h-[61vh] w-screen bg-[#53678d] rounded-b-[7vh] rounded-bl-[7vh] '>

         </div>
         <div class="text-white px-8 py-6  w-screen bg-gray-800 absolute" style={{bottom : "0vh", padding : "5vh"}}>
